...
For Nginx run this one:
```
stream {
    upstream stream_backend {
        least_conn;
        server ip-10-0-16-120.ap-south-1.compute.internal:6443;
        server ip-10-0-16-125.ap-south-1.compute.internal:6443;
    }
...
Run UserData for the KUbernets Cluster Creation from scratch in AWS:
